...
Description:
    Replaces Binary Cross-Entropy with Contrastive Loss
    for metric learning on signature embeddings.

    ✅ Safe to load (no Lambda layers)
    ✅ Uses EuclideanDistanceLayer
    ✅ Compatible with Evaluate_ROC.py
...
# ======================================================
# 🔗 BUILD SIAMESE NETWORK (SAFE DISTANCE LAYER)
# ======================================================
